...
func mainRoutes() -> [[String: Any]] {
	...
	*/
	...
	// POLL Server
	// =========================================================================================
	routes.append(["method":"get", "uri":"/polls", "handler":PollHandlers.list])
	routes.append(["method":"get", "uri":"/polls/create", "handler":PollHandlers.mod])
	routes.append(["method":"get", "uri":"/polls/{id}/edit", "handler":PollHandlers.mod])
	routes.append(["method":"post", "uri":"/polls/create", "handler":PollHandlers.modAction])
	routes.append(["method":"post", "uri":"/polls/{id}/edit", "handler":PollHandlers.modAction])
	routes.append(["method":"delete", "uri":"/polls/{id}/delete", "handler":PollHandlers.delete])

	routes.append(["method":"post", "uri":"/", "handler":PollHandlers.vote])
